...
function preload() {
  //load image
  bgImage = loadImage("bggg.jpg");
  ropeImage = loadImage("rope.png");
  introbgImage = loadImage("introbg.jpg");
  gameoverImg = loadImage("defeatbg.png");
  bulletImage = loadImage("bullet.png");
  gunImage = loadImage("gun.png");
  bodyImage = loadImage("body.png");
  buttonImg = loadImage("playbutton.jpg");
  carImg = loadImage("car.png");
  howplayImg = loadImage("howtoplay.jpg");
  playAgainImg = loadImage("playagain.png");
  quitImg = loadImage("quit.png");
  howplayscreenImg = loadImage("howplayscreen.png");
  ...
  enemyImage = loadAnimation("imposter1.png");
  enemyOpen = loadAnimation("imposter2.png");
  heartImage = loadAnimation("heart1.png");
  heart2Image = loadAnimation("heart2.png");

  youStand = loadAnimation("standamong.png");
  youDeath = loadAnimation("ghost.png");

  //load sounds
  heliSound = loadSound("spacecraft.mp3");
  hurtSound = loadSound("hurt.mp3");
  //bgSound = loadSound("bgplay.mp3");
  introSound = loadSound("amongustheme.mp3");
